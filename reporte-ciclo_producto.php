...
if(isset($_GET['id_prod_cod']))
{
  ConectarBD();
  $numero=$_GET['id_prod_cod'];
}

else{
   $numero= DameElPrimerCodigo();
}
...
<div class="wrapper-main">
  <div class="container">
      ...
      <div class="panel panel-primary">
               <div class="panel-heading"><h3 class="panel-title">Entrada y Salidas del Producto:</h3> 
               </div>               
       ...
       <table class="table table-hover">
        ...
        <tbody>
            <?php 
              $sql="SELECT * FROM tmov WHERE fcodigoproducto = $numero ORDER BY fid";
 ...
 <div class="panel panel-primary">
               <div class="panel-heading"><h3 class="panel-title">Gráfico de entrada y salida del producto</h3></div>               
                  <div class="panel-body">
  ...
  <div class="panel panel-primary unoInve">              
             <div class="panel-body">
               ...
               $result = mysql_query($sql);
                 while($row = mysql_fetch_assoc($result))
                   { 
                      echo "<a href=\"reporte-ciclo_producto.php?id_prod_cod=".$row['fcodigo']."\" type=\"button\" class=\"btn btn-default navbar-btn Boton-inf\"> ".$row['fnombre']." </a>";
                   } 
               ?>
             </div> 
           </div> 
